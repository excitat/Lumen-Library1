...
<div class="container">
	...
	<?php
        ...
        {
            $q=mysqli_query($db,"SELECT firstname,lastname,username,matricule,email,contact FROM student WHERE username like '%$_POST[search]%' ");
            ...
            else
            {
                ...
                echo "<th>"; echo "Matricule No"; echo "</th>";
                ...
                while ($row = mysqli_fetch_assoc($q)) {
                    ...
                    echo "<td>"; echo $row['matricule']; echo "</td>";
        ...
        {
            $res=mysqli_query($db,"SELECT firstname,lastname,username,matricule,email,contact FROM student ORDER BY firstname ASC;");
            if ($res)
            {
                echo "<table class='table table-bordered table-hover'>";
                echo "<tr style='background-color: #3abfdd;'>";
